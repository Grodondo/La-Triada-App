...
public class DatabaseInitialData {
	...
	public static void insertarDatosIniciales() {
		try {
			// Insertar coches
			Vehiculo.insertarVehiculoInicial("7654DCY", "coche", "toyota", "corolla sedan", "berlina", "hibrido", 5.00, 5,
					45678, 15000.00, 20.00, false);
			Vehiculo.insertarVehiculoInicial("9238JRC", "coche", "toyota", "c-hr", "suv", "hibrido", 4.70, 5, 98734, 18900.00,
					23.90, false);
			Vehiculo.insertarVehiculoInicial("6789LTR", "coche", "toyota", "yaris", "turismo", "hibrido", 4.60, 5, 20345,
			...
			// Insertar motos
			Vehiculo.insertarVehiculoInicial("7539JBR", "moto", "bmw", "r 1300 gs", "tracker", "gasolina", 5.00, null, 14556,
					15000.00, 20.00, false);
			Vehiculo.insertarVehiculoInicial("8743GVT", "moto", "kawasaki", "ninja 400", "sport", "gasolina", 4.90, null,
					19384, 14000.00, 19.00, false);
			Vehiculo.insertarVehiculoInicial("9874HRC", "moto", "yamaha", "xsr125 legacy", "heritage", "gasolina", 4.57, null,
					12345, 13900.00, 18.00, false);

			// Insertar camiones
			Vehiculo.insertarVehiculoInicial("8742GTR", "camion", "mercedes", "atego 1418", "ligero", "diesel", 6.34, 3, 23456,
					19000.00, 24.00, false);
			Vehiculo.insertarVehiculoInicial("7934LTC", "camion", "iveco", "stralis ad", "pesado", "diesel", 5.79, 3, 45678,
					18000.00, 23.00, false);
			Vehiculo.insertarVehiculoInicial("9876KCT", "camion", "volvo", "fh16 750", "pesado", "diesel", 5.95, 3, 34563,
					15000.00, 20.00, false);
